       ...
       <div>
            ...
            <div className="cover-wrapper">
                ...
                <navbar className="nav">
                    <div className='logo'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="20" viewBox="0 0 331.644 40.825">
                    ...
                    <div className="dropdown dropleft menu">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a className="dropdown-item small" href="#">PROJECTS</a>
                            <a className="dropdown-item small" href="#">EQUIPE</a>
                            <a className="dropdown-item small" href="#">CONTACT</a>
                        </div>
                    </div>
